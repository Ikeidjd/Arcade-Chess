...
class MovePacket:
    def __init__(self, src_color: PieceColor, start: list[PiecePos] | None = None, end: list[PiecePos] | None = None,
                 capture: PiecePos | None = None, future_en_passant_pos: PiecePos | None = None, promotion_piece: tuple[PieceType, PieceColor] | None = None) -> None:
        ...
        self.capture: PiecePos | None = capture
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "capture": self.capture if self.capture is None else (self.capture.rank, self.capture.file),
    ...
    def from_dict(cls, data: dict[str, Any]) -> "MovePacket":
        return cls(
            ...
            data["capture"] if data["capture"] is None else PiecePos(*data["capture"]),
